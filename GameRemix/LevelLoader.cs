...
namespace GameRemix
{
    internal class LevelLoader
    {
        ...
        internal LevelLoader(int size, ILevelDataSource levelDataSource)
        {
            this.levelDataSource = levelDataSource;
            this.size = size;
        }

        internal void LoadRooms(Dictionary<char, Rectangle> tileMap)
        {
        ...
        internal Room GetRoom(int roomX, int roomY)
        {
